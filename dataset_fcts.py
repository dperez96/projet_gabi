...
def ahi_list(file_ids):
    ...
    :param file_ids: 4 digits string
    :return: list of int for new_id and list of float for new_ahi
    """
...
def check_variable_quality(variable, threshold):
    ...
    :param threshold: int
    :return: the function just prints the solution, doesn't return anything
    """
